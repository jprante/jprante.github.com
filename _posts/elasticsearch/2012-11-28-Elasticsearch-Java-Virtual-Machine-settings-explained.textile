...
This blog tries to demystify the preconfigured Elasticsearch settings and discusses the most common adjustments. Finally, some recoomendations are given how tunings should be undertaken.
