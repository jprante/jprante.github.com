...
Using elasticsearch.org as a download platform could be an alternative to move my plugin business to. But I think this should be private to the core plugins developed by Elasticsearch. And, third-party code hosting needs some careful precautions that are not met yet by the company, and the human resources to maintain such a service may impact the development of new exciting Elasticsearch code (like the move to Lucene 4).
...
I was happy when I learned about Bintray last December. Bintray is a social platform for the storage and distribution of software binaries. The cloud-based platform is offered to open source developers free of charge. It helps in the process of making binaries publicly available. The company behind Bintray is JFrog, known from Artifactory, a competitor to Nexus, and is well established in the business of providing Maven repositories.
...
fn1. "https://github.com/blog/1302-goodbye-uploads"

fn2. http://www.elasticsearch.org/blog/2012/12/17/new-download-service.html The hardcoded URLs for looking for zip files in Maven repos are http://search.maven.org/remotecontent?filepath= and https://oss.sonatype.org/service/local/repositories/releases/content/ 

fn3. http://maven.apache.org/guides/mini/guide-central-repository-upload.html

fn4. https://github.com/jprante/elasticsearch-apps

fn5. http://www.drdobbs.com/cloud/need-a-new-binary-ask-a-developer-first/240146444

fn6. https://bintray.com/docs/terms_of_service.html
